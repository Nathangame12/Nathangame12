...
*Especialista em criação de conteúdo visual e identidade digital.*
- 📺 **Portfólio:** [Confira minhas edições no YouTube](https://youtube.com/@nathangame12?si=tj4NpdMJyfT9MENS)
- 🛠️ **Ferramentas:** YouCut, IbisPaint, AudioVisualizer.

## 🎵 Produção Musical
*Composição sonora para jogos, vídeos e projetos autorais.*
- 🎧 **Listen now:** [Ouça minhas trilhas no SoundCloud](https://on.soundcloud.com/4qmeKYXSMqRh5n53ss)
- 🎹 **Gêneros:** Eletrônica, Indie e Trilha Sonora para Jogos.
